...
```{r, echo=T, eval=F}
rmarkdown::render('RTemplate_Poster.Rmd')
```
...
<!-- ## COMPILE FROM CLI
    Rscript -e "rmarkdown::render('RTemplate_Poster.Rmd')"
    pandoc RTemplate_Poster.html -t latex -o RTemplate_Poster.pdf
    Rscript -e "pagedown::chrome_print('RTemplate_Poster.html')"
--->    
