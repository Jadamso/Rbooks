...
```
##  [1] -1.2152695 -1.1205322  1.7243277  1.6766968 -1.6734287 -0.7212411
##  [7] -0.7103431  3.5489409  0.8816030 -0.3542427
```
...
```
##  [1] -0.21506519 -1.16115356  1.27714380  1.52246843 -0.06566486 -0.60140113
##  [7] -0.05727936 -0.06872125 -2.02668655  1.12892687
```
...
```
## [1] 0.6001499 0.3631205 0.9956528 0.8999873 0.1141623 0.6103621
```
...
```
##        x            y
## 1 1.0000  0.835009234
## 2 1.0002  0.737013324
## 3 1.0004  0.729617499
## 4 1.0006  0.783068937
## 5 1.0008  0.510626030
## 6 1.0010 -0.005537904
```
...
## -4.1402 -0.6740 -0.0055  0.6694  4.5367 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)    
## (Intercept) 0.005660   0.010983   0.515    0.606    
## x           0.249268   0.001806 138.059   <2e-16 ***
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 0.9951 on 44999 degrees of freedom
## Multiple R-squared:  0.2975,	Adjusted R-squared:  0.2975 
## F-statistic: 1.906e+04 on 1 and 44999 DF,  p-value: < 2.2e-16
```
