...
We can analytically solve this problem using [matrix-calculations](https://jadamso.github.io/Rbooks/03_25_MiscTopics.html#matrix-calculations), although we do not do that here. Solving yields the best fitting model with coefficients $B^{*}=(b_0^{*} ~~ b_1^{*} ~~... ~~ b_{K}^{*})$.
