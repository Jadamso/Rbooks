...
We often want to know the relationship between one outcome variable $\hat{Y}_{i}$ and multiple explanatory/predictor variables. This builds on [Simple Regression](https://jadamso.github.io/Rbooks/02_13_SimpleRegression.html), which related $\hat{Y}_{i}$ to a single explanatory variable. For historical reasons, we start by fitting a linear model to data.
