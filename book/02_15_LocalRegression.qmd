...
After minimizing the sum of squared errors in a the regressions below, our estimated models $\hat{m}$ will also predict local averages.
...
For some intuition, consider a point $x$ and the model $\hat{Y}_{i} = b_{0}(x, h) + e_{i}$.
