...
With $\hat{F} \approx F$ by the [Glivenko-Cantelli theorem](#the-fundamental-theorem-of-statistics) above, each bootstrap sample is approximately a random sample.
