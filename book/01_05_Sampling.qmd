...
The four-student example tied these ideas to concrete numbers: from ages $\{18, 20, 22, 24\}$ there are six possible samples of size $n=2$ giving six sample means $\{19, 20, 21, 21, 22, 23\}$ centered on the population mean $21$ — the histogram of those six values is the sampling distribution of $\hat{M}$.
