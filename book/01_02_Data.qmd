...
Note that histograms qualitatively depict different proportions (since each bar represents the proportion of data in its bins), but you can also directly compute proportions.
...
Also note that if you your data are factor data, or discrete cardinal data, you can directly plot the proportions in a *bar plot*. For each unique outcome $x$ we compute
\begin{eqnarray}
