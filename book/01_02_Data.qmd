...
\end{eqnarray}
Typically, we compute this for each unique value of $x$ in the dataset. The ECDF jumps up by $1/n$ at each of the $n$ data points (see this [ECDF walkthrough](https://library.virginia.edu/data/articles/understanding-empirical-cumulative-distribution-functions) for visual examples).
...
This chapter classified data into cardinal/factor types and showed how to depict a distribution with proportions, histogram density, kernel density, ECDFs, quantiles, and boxplots.
