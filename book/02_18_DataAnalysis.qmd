...
* <https://bookdown.org/yihui/rmarkdown/> -- the definitive R Markdown guide, covering document types, code chunks, and output formats.
* <https://r4ds.had.co.nz/r-markdown.html> -- practical chapter on integrating R Markdown into a data-analysis workflow.
* <https://github.com/RStudio/cheatsheets/blob/main/rmarkdown.pdf> -- two-page cheat sheet for quick reference on chunk options and formatting syntax.
