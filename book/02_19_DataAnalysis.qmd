...
The next chapter opens Part 3 with multiple linear regression, extending the single-predictor model from [Simple Regression](02_14_SimpleRegression.qmd) to many explanatory variables at once.
