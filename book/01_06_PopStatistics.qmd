...
Nonetheless, the sample standard deviation can be used to estimate the standard error of the sample mean. Specifically, assume that the data are approximately i.i.d with the sample mean being approximately normal and approximate the population standard deviation, $\sigma$, with the sample standard deviation, $\hat{S}$;
\begin{eqnarray}
SE(M) \approx \sigma^2/n \approx \hat{S}/\sqrt{n}. 
\end{eqnarray}
