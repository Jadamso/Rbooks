...
Done by AI, you may unwittingly use a different formula.
...
This is especially important when using AI in your workflow.
...
Later, in [Data Analysis](02_19_DataAnalysis.qmd) we will also work with Quarto, so the text, code, and figures of a report can live in one file that rebuilds itself when the data change.]
