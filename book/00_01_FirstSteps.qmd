...
This chapter introduced the R environment, the three basic objects (scalars, vectors, matrices), and the tools to manipulate them: functions, loops, and logical comparisons.
