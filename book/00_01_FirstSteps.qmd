...
Later, in [Data Analysis](02_20_DataAnalysis.qmd) we will also work with Quarto, so the text, code, and figures of a report can live in one file that rebuilds itself when the data change.]
