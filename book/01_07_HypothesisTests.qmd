...
The above procedure also generalizes to many other statistics. Perhaps the most informative are differences in spread or shape. E.g., you can conduct hypothesis tests for `sd` and `IQR`, or `skew` and `kurtosis`.
...
#### **One-Sided Intervals that "Impose the Null"**. {-}
