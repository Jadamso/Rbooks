...
Often: bootstrap $>$ jackknife $>$ theory, but not always.
...
Using either the bootstrap or jackknife distribution, we typically comminicate the variability of the sampling distribution of a statistic using the *Standard Error*. In either case, this differs from the standard deviation of the data within your sample.
