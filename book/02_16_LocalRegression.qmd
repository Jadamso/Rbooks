...
xcut3 <- cut(xy_hat[, 'x_hat'], seq(32, 92, by=20)) # Finer Bins
...
x0_hat <- 1:5
y_sim <- round( rnorm(length(x0_hat)) , 2)
y_sim
## plot(x0_hat, y_sim)
...
y_fit_5 <- sum(k5_weights*y_sim)
y_fit_5

## Edge Correction
k5_weights_ec <- k5_weights/sum(k5_weights) 
y_fit_5_ec <- sum(k5_weights_ec*y_sim)
y_fit_5_ec
```
:::
