...
The basic idea of RDD/RKD is to examine how a variable changes just before and just after a treatment (for a thorough introduction, see [The Effect, Ch. Regression Discontinuity](https://theeffectbook.net/ch-RegressionDiscontinuity.html)). RDD estimates the difference in the levels of an outcome variable, whereas RKD estimates the difference in the slope. Turning to our canonical competitive market example, the RDD estimate is the difference between the lines at $T=300$.
...
The basic idea of DID is to examine how a variable changes in response to an exogenous shock, *compared to a control group* (see [The Effect, Ch. Difference-in-Differences](https://theeffectbook.net/ch-DifferenceinDifference.html) for more detail).
