...
We often want to know the relationship between one outcome variable $\hat{Y}_{i}$ and $K$ explanatory variables: $\hat{X}_{1i},  \hat{X}_{2i},... \hat{X}_{Ki}$. For historical reasons, we start by fitting a linear model to data.  
