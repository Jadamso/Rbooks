...
| ------------------ | --------------------------- | ------------ | -------------------------- |
| Standard deviation | individual observations     | sample: \hat{S}, population $\sigma$  | spread of the distribution |
| Standard error     | a statistic                 | $SE(M)$ | sampling variability |
