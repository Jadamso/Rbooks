...
Any number on the interval $[a,b]$ allowing for any number of decimal points, with every sub-interval of the same length having the same probability.
\begin{eqnarray}
X_{i} &\in& [a,b] \\
f(x) &=& \begin{cases}
    1/(b-a) & x \in [a,b] \\
...
This chapter introduced random variables, distinguished discrete (Bernoulli, Uniform, Multinoulli) from continuous (Uniform, Exponential, Normal), and showed how the CDF and the PDF describe them.
