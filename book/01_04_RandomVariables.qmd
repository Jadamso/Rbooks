...
The opposite probability of $X_{i} > b$ or $X_{i} \leq a$ is $Prob(X_{i} \leq a \text{ or } X_{i} > b) = F(a) + [1- F(b)]$. Notice that this opposite probability $F(a) + [1- F(b)] =1 - [F(b) - F(a)]$, so that $Prob(X_{i} \text{ out of } (a,b]) = 1 - Prob( X_{i} \in (a,b])$
