...
#### **Normal (Gaussian)**. {-}
Any number on the real line, $X_{i} \in (\infty,\infty)$, with bell shaped probabilities. The distribution is mathematically complex, but we will encounter it again and again and again. The density function $f$ has two parameters $\mu \in (\infty,\infty)$ and $\sigma > 0$
\begin{eqnarray}
