...
plot(proportions, col=grey(0,.5), ylim=c(0,0.7),
    xlab='Outcome', ylab='Proportion', main=NA)
points(seq(x), x_probs, pch=16, col='blue') # Theoretical values
...
hist(X, breaks=bks, freq=F, border=NA)
hist(floor(Y), breaks=bks, freq=F, border=NA)
```
:::
