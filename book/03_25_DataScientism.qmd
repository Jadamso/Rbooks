...
As discussed in the chapter introduction, good natural experiments are hard to find and bad ones are easy to find. The remainder of this section illustrates the second point: applying canonical causal-inference recipes (IV, RDD, DID) to data that is purely noise.
