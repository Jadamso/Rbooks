...
As such, there are two different types of confidence intervals. (While we could also use a Null Jackknife distribution, that is rarely done.)
...
: Types of Confidence Interval Estimates
