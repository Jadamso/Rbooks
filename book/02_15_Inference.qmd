...
The linear model from [Simple Regression](02_13_SimpleRegression.qmd) depicts this as a single constant, $\hat{b}_{1}$, but the local-regression models from [Local Regression](02_14_LocalRegression.qmd) do not.
