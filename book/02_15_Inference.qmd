...
:::{.callout-important title="Definition" collapse="false"}
The expected prediction error of an estimator decomposes into squared *bias* — how far its average prediction sits from the truth — plus *variance* — how much its predictions wobble around their own average. Cutting one usually raises the other.
:::
