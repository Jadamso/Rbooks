...
points(wage~school, data=school_means, pch=17, col='blue', type='b')
...
lines( dat[,'school'], predict(reg), lwd=2, col=2)
lines( dat[,'school'], predict(rgram_f), lwd=2, col=4, type='s')
legend('topleft',
...
## Compare Models
lines( dat[,'school'], predict(preg_c), lwd=2, col=5)
lines( dat[,'school'], predict(preg_f), lwd=2, col=6)
legend('topleft',
