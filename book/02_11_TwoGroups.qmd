...
A permuted statistic at least as large as the observed one is evidence *for* the null, so the $p$-value is the fraction of permutations that match or exceed the observed statistic.
