...
Under the assumption that both populations are normally distributed, we can analytically derive the sampling distribution for the difference-in-means between two groups. In particular, the $t$-statistic
\begin{eqnarray}
\hat{t} = \frac{
