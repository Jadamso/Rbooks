...
The central limit theorem has an example with the Cauchy distribution, the bootstrap is applied to estimate a maximum, and linear regression is applied to non-linear data (students are not taught to simply assume $Y=X\beta+\epsilon$).
Students actually learn the maxim "all models are wrong" instead of how to prove unbiasedness.
...
**Fifth**, students learn statistical reporting using R + markdown, which research suggests is a good combination for students [1](https://doi.org/10.1080/00220485.2019.1618765) [2](https://doi.org/10.1002/jae.657).
