...
We can not compute the often-used the Pearson correlation:
\begin{eqnarray}
...
Similarly, we can also compute the regression coefficient
\begin{eqnarray}
\frac{\mathbb{C}[X_{i}, Y_{i}] }{ \mathbb{V}[X_{i}] }
\end{eqnarray}
