...
When explicitly transforming data according to $\lambda$ and $\rho$, these parameters increase the degrees of freedom by two. The default hypothesis testing procedures do not account for you trying out different transformations, and should be adjusted by the increased degrees of freedom. *Specification searches* deflate standard errors and are a major source for false discoveries (see [Data Scientism](03_25_DataScientism.qmd)).
