...
This chapter summarized distributions with single numbers: mean and variance for center and spread, plus robust alternatives (median, IQR, MAD) and shape statistics (skewness, kurtosis).
In the next chapter we flip the script: instead of computing statistics from data, we generate data from a known random-variable model.
:::
